                    ...
                    if (usersData.getPhone().equals(number)) {
                        ...
                        if (usersData.getPassword().equals(password)) {
                           ...
                           if (parentDBName.equals("Admins")) {
                               Toast.makeText(Login_New.this,"Your are logged in!!", Toast.LENGTH_SHORT).show();
                               loadingBar.dismiss();

                               Intent intent = new Intent(Login_New.this,Org_Home_Page.class);
                               ...
                               Intent intent = new Intent(Login_New.this,HomeActivity1User.class);
                            ...
                            loadingBar.dismiss();
                            Toast.makeText(Login_New.this,"Password is incorrect!!", Toast.LENGTH_SHORT).show();

                        }
                    }
                }
                else {
                    Toast.makeText(Login_New.this,"Account with this "+number+ " do not exist", Toast.LENGTH_SHORT).show();
                    loadingBar.dismiss();
                }
            }
